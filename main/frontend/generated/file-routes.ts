...
import * as Page_4 from "../views/banda-list.js";
import * as Page_5 from "../views/Cancion-list.js";
import * as Page_6 from "../views/Genero-list.js";
...
const routes: readonly AgnosticRoute_1[] = [
    createRoute_1("", Layout_1, [
        ...
        createRoute_1("banda-list", Page_4),
        createRoute_1("Cancion-list", Page_5),
        createRoute_1("Genero-list", Page_6),
